        ...
        <div className="max-w-3xl mx-auto">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-error-700">
                    ...
                    <p className="mt-2 flex items-center font-semibold text-lg">
                      ...
                      <a href="tel:119" className="text-primary-600 hover:text-primary-700">119</a>
                      <span className="mx-2">atau</span>
                      <a href="tel:112" className="text-primary-600 hover:text-primary-700">112</a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="mb-8">
            ...
            <CardBody>
              <div className="space-y-4">
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">1. Tetap Tenang</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                    Tarik napas dalam-dalam. Krisis akan berlalu. Jika memungkinkan, pindah ke tempat yang aman dan tenang.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">2. Hubungi Bantuan</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                    Segera telepon salah satu nomor darurat di atas. Mereka terlatih untuk membantu Anda dalam situasi ini.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">3. Beritahu Seseorang</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                    Jika mungkin, hubungi teman atau keluarga yang Anda percaya untuk mendapatkan dukungan.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">4. Jangan Sendiri</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-4">
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">1. Ambil Situasi dengan Serius</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                    Selalu anggap serius jika seseorang berbicara tentang menyakiti diri sendiri atau bunuh diri.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">2. Dengarkan Tanpa Menghakimi</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                ...
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">3. Bantu Mereka Mendapatkan Bantuan</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                    Tawarkan untuk membantu mereka menghubungi layanan krisis atau antar mereka ke rumah sakit jika diperlukan.
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-semibold text-gray-800 mb-1">4. Jaga Keamanan Mereka</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
